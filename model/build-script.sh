...
cd "$SKELS" && rm -f imagesender.zip && zip imagesender imagesender/* && cd $OLDPWD

cd "$SKELS" && rm -f imagereceiver.zip && zip imagereceiver imagereceiver/* && cd $OLDPWD

cd "$SKELS" && rm -f testproducer.zip && zip testproducer testproducer/* && cd $OLDPWD

cd "$SKELS" && rm -f testconsumer.zip && zip testconsumer testconsumer/* && cd $OLDPWD
...
cd "$CWD" && assert-builder-ocarina.py \
	...
	-o "$OUTPUTDIR" \
	--subC imagesender:"$SKELS"/imagesender.zip \
	--subC imagereceiver:"$SKELS"/imagereceiver.zip \
	--subC testproducer:"$SKELS"/testproducer.zip \
	--subC testconsumer:"$SKELS"/testconsumer.zip \
